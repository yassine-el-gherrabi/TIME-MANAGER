...
const sheetVariants = cva(
  'fixed z-50 gap-4 bg-background p-6 shadow-lg transition-all data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-300 ease-out',
  {
    variants: {
      side: {
